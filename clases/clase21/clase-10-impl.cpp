...
ImpresoraGenerica::ImpresoraGenerica(const string& nombre) :
  Impresora(nombre) { }

ImpresoraGenerica::~ImpresoraGenerica() { }

void ImpresoraGenerica::imprimir(const string& texto) {
...
ImpresoraBurbuja::~ImpresoraBurbuja() { }
